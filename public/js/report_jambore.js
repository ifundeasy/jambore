var main = function () {
    ...
    var url = {
        sum : "/api/aJambore?q=sum",
        detail : "/api/aJambore?q=detail"
    };
    var el = {
    ...
    GET(url.sum, function (res) {
        ...
        res.data.forEach(function (data) {
            ...
            tr.append(
                ...
                '<button txt="lihat rincian" class="btn btn-xs btn-danger -detail" type="button" data-original-title="" title="">' +
