var main = function () {
    ...
    var url = {
        sum : "/api/aKegiatan?q=sum",
        detail : "/api/aKegiatan?q=detail"
    };
    var el = {
    ...
    var initDetail = function (res) {
        ...
        res.data.forEach(function (data) {
            ...
            tr.data(data);
            tr.append('<td txt="' + data.kegiatan_name + '">' + data.kegiatan_name + '</td>');
...
'<th>Group Kegiatan</th>' +
        ...
        res.data.forEach(function (data) {
            ...
            data.kegiatan_id = data.kegiatan_id == " " ? "" : data.kegiatan_id;
            data.sanggar = data.sanggar == " " ? "" : data.sanggar;
